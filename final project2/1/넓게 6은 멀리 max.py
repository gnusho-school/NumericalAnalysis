...
mean_x=[random.randrange(0,100) for i in range(5)]
mean_y=[random.randrange(0,100) for i in range(5)]
mean_z=[random.randrange(0,100) for i in range(5)]
mean_x.append(random.randrange(150,200))
mean_y.append(random.randrange(150,200))
mean_z.append(random.randrange(150,200))
sigma_x=[random.randrange(0,100) for i in range(6)]
sigma_y=[random.randrange(0,100) for i in range(6)]
sigma_z=[random.randrange(0,100) for i in range(6)]
